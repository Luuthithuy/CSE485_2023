      ...
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">Sinh viên điểm danh</h1>
            <ol class="breadcrumb">
              <li class="breadcrumb-item"><a href="./">Trang chủ</a></li>
              <li class="breadcrumb-item active" aria-current="page">Thống kê điểm danh</li>
            </ol>
          </div>
            ...
            <div class="col-lg-12">
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Sinh viên điểm danh</h6>
                  <?php echo $statusMsg; ?>
                </div>
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                      <div class="col-xl-6">
                        <label class="form-control-label">Lựa chọn sinh viên<span class="text-danger ml-2">*</span></label>
                        <?php
                        ...
                        if ($num > 0) {
                          ...
                          echo '<option value="">--Sinh viên--</option>';
                      ...
                      <div class="col-xl-6">
                        <label class="form-control-label">Thời gian<span class="text-danger ml-2">*</span></label>
                        <select required name="type" onchange="typeDropDown(this.value)" class="form-control mb-3">
                          ...
                          <option value="3">Khoảng thời gian</option>
                        </select>
                      </div>
                    </div>
                    <?php
                    ...
                    ?>
                    <button type="submit" name="view" class="btn btn-primary">Lịch sử điểm danh</button>
                  </form>
                </div>
              </div>
