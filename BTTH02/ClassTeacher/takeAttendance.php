                  ...
                  <div class="col-lg-12">
                    <div class="card mb-4">
                      <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                        <h6 class="m-0 font-weight-bold text-primary">(<?php echo $rrw['className'] . ' - ' . $rrw['classArmName']; ?>)</h6>
                      </div>
                      ...
                      where tblstudents.classId = '$_SESSION[classId]' and tblstudents.classArmId = '$_SESSION[classArmId]'";
                        ...
                        <br>
                        <button type="submit" name="save" class="btn btn-primary">Tạo điểm danh</button>
              </form>
            </div>
          </div>
        </div>
